...
while running:
    ...
    if screen == "Files":
        ...
        listy = open("files","r")
        listy.seek(0)
        numoffiles = len(listy.read().split())
        listy.close()
        window.blit(back_arrow,(100,100))
